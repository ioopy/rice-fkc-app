...
desc_msg1 = '''
    ...
    - **Lazada** มีอัตราการลดราคาสินค้าเฉลี่ยสูงกว่าที่ **10.52%**
    - **Shopee** มีอัตราการลดราคาสินค้าเฉลี่ยอยู่ที่ **4.32%**

    อย่างไรก็ตาม ยอดขายรวมของ Shopee สูงกว่า Lazada อย่างมาก โดย Shopee มียอดขายรวมประมาณ **48,756,397 บาท** ขณะที่ Lazada มียอดขายรวมเพียง **9,399,943 บาท**

'''
summary1 = '''
    สรุป:\n
    แม้ว่า Lazada จะมีอัตราการลดราคาสูงกว่า Shopee แต่ Shopee มียอดขายรวมสูงกว่าอย่างมาก ซึ่งชี้ให้เห็นว่าการลดราคาไม่ใช่ปัจจัยเดียวที่ส่งผลต่อยอดขาย
'''

desc_msg2 = '''
    จากการวิเคราะห์พบว่า: \n
    - สินค้าที่มีส่วนลดสูงสุดใน Shopee อยู่ในช่วง **71-80%** โดยมียอดขายรวม **21,986,200 บาท**
    - สินค้าที่มีส่วนลดสูงสุดใน Lazada อยู่ในช่วง **0-10%** โดยมียอดขายรวม **5,338,911 บาท**
'''
summary2 = '''
    สรุป:\n
    สินค้าที่มีส่วนลดสูงสุดใน Shopee มียอดขายสูงกว่า Lazada อย่างมาก โดยยอดขายใน Shopee สูงกว่าถึงประมาณ 4 เท่า
'''
