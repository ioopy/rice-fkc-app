...
desc_msg1 = '''
    สินค้าที่มียอดรีวิวเฉลี่ยสูงที่สุดในแต่ละแพลตฟอร์มมีดังนี้: \n
    - **Shopee**: สินค้าที่มียอดรีวิวเฉลี่ยสูงสุดคือ "ข้าวหอมแม่จัน" โดยได้คะแนนรีวิวเฉลี่ย 5.0
    - **Lazada**: สินค้าที่มียอดรีวิวเฉลี่ยสูงสุดคือ "ข้าวพันธุ์ กข 10" โดยได้คะแนนรีวิวเฉลี่ย 5.0
'''
summary1 = '''
    สรุป:\n
    ทั้ง Shopee และ Lazada มีสินค้าที่มียอดรีวิวเฉลี่ยสูงที่สุดที่คะแนนเต็ม 5.0 โดยสินค้าที่ได้รับการรีวิวสูงสุดในแต่ละแพลตฟอร์มแตกต่างกัน
'''

desc_msg2 = '''
    จากการวิเคราะห์พบว่า: \n
    - สินค้าที่มีราคาสูงกว่าค่าเฉลี่ยมีคะแนนรีวิวเฉลี่ยอยู่ที่ 4.49
    - สินค้าที่มีราคาต่ำกว่าค่าเฉลี่ยมีคะแนนรีวิวเฉลี่ยอยู่ที่ 4.62
'''
summary2 = '''
    สรุป:\n
    สินค้าที่มีราคาสูงกว่าค่าเฉลี่ยมีแนวโน้มได้รับรีวิวต่ำกว่าสินค้าที่มีราคาต่ำกว่าค่าเฉลี่ยเล็กน้อย
'''
